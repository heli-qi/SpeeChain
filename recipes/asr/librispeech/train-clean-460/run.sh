...
function print_help_message {
  ...
  $0 \\ (The arguments in [] are optional while other arguments must be given)
    ...
    --exp_cfg EXP_CFG \\                                    # The name of your specified configuration file in ${SPEECHAIN_ROOT}/recipes/asr/librispeech/train-clean-460/exp_cfg
    [--data_cfg DATA_CFG] \\                                # The name of your specified configuration file in ${SPEECHAIN_ROOT}/recipes/asr/librispeech/train-clean-460/data_cfg (default: none)
    [--train_cfg TRAIN_CFG] \\                              # The name of your specified configuration file in ${SPEECHAIN_ROOT}/recipes/asr/librispeech/train-clean-460/train_cfg (default: none)
