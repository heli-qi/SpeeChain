...
#  --config ./transformer/exp_cfg/bpe5k_25ms+10ms+400nfft_accum2.yaml \
#  --train \
#  --dry_run \
#  --num_epochs 1 \
#  --ngpu 4
...
# In the example below, the experimental files will be saved to ./transformer/exp/bpe5k_25ms+10ms+400nfft_accum2
### ------------------------- ###
#${python} ${speechain}/runner.py \
#  --config ./transformer/exp_cfg/transformer_prenorm_specaug.yaml \
...
${python} ${speechain}/runner.py \
  ...
  --test_cfg ${infer_root}/beam32_temperature1.3.yaml \
  --test \
  --ngpu 2
